...
/**
 * A test and demonstration of the behavior of the {@link Pointer#to(Buffer)}
 * and {@link Pointer#toBuffer(Buffer)} methods.
 */
public class TestPointerToBuffer {
	...
	public static void main(String[] args) {
		...
		FloatBuffer directBuffer = ByteBuffer
				.allocateDirect(array.length * Sizeof.FLOAT)
	...
	/**
	 * Copy data from the given buffer into an array, and return whether the
	 * array contents matches the expected result. The data will be copied from
	 * the given buffer using a Pointer that is created using the
	 * {@link Pointer#to(Buffer)} method.
	 * 
	 * @param buffer
	 *            The buffer
	 * @param elements
	 ...
	 */
	private static boolean copyWithTo(FloatBuffer buffer, int elements,
			float[] expected) {
	 ...
	 * array contents matches the expected result. The data will be copied from
	 * the given buffer using a Pointer that is created using the
	 * {@link Pointer#toBuffer(Buffer)} method.
	 * 
	 * @param buffer
	 *            The buffer
	 * @param elements
	 ...
	 * @return Whether the contents of the array matched the expected result
	 */
	private static boolean copyWithToBuffer(FloatBuffer buffer, int elements,
			float[] expected) {
	...
	/**
	 * Copy data from the given buffer into an array, using the given pointer,
	 * and return whether the array contents matches the expected result
	 * 
	 * @param buffer
	 *            The buffer
	 * @param pointer
	 ...
	 * @return Whether the contents of the array matched the expected result
	 */
	private static boolean copy(FloatBuffer buffer, Pointer pointer,
			int elements, float expected[]) {
		...
		JCuda.cudaMemcpy(Pointer.to(result), pointer, elements * Sizeof.FLOAT,
