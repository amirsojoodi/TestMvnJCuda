...
/**
 * A sample demonstrating the different pointer modes for CUBLAS 2. With CUBLAS
 * 2, functions may receive pointers as arguments which are either used as input
 * parameters or will store results. These pointers may either be pointers to
 * host or to device memory. This sample shows how to obtain the result of a
 * 'dot' operation in host- or device memory.
 */
public class JCublas2PointerModes {
	...
	public static void main(String[] args) {
		...
		cudaMemcpy(Pointer.to(deviceResult), deviceResultPointer, Sizeof.FLOAT,
		...
		System.out.println("Device call duration: " + deviceCallDuration
				+ " ms");
		System.out.println("Device full duration: " + deviceFullDuration
				+ " ms");
