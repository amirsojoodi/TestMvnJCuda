...
/**
 * This is a sample class that performs a 1D Complex-To-Complex forward FFT with
 * JCufft, and compares the result to the reference computed with JTransforms.
 */
class JCufftSample {
