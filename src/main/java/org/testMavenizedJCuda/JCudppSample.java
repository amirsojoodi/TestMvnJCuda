...
/**
 * This is a sample class demonstrating the application of JCudpp for performing
 * a sort of an integer array with 1000000 elements.
 */
public class JCudppSample {
	...
	private static void sort(int array[]) {
		...
		// JCudpp.cudppMergeSort(handle, d_keys, null, n);
